...
namespace NewCsharpFeaturesSamples.PatternMatching
{
    public class PatternMatching
    {
        ...
        public static double ComputeAreaModernSwitch(IShape shape)
        {
            return shape switch
            {
        ...
        public static double ComputeArea_Version4(object shape)
        {
            ...
            return shape switch
            {
                ...
                Circle c when c.Radius == 0 => 0, //Circle { Radius: 0 } => 0,
